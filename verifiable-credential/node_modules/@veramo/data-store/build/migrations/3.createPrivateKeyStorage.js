 ...
 * @public
 */
export class CreatePrivateKeyStorage1629293428674 {
    async up(queryRunner) {
        ...
        // 2. copy key data
        const keys = await queryRunner.manager.find(PreMigrationKey);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.addColumn('key', new TableColumn({
            name: 'privateKeyHex',
            type: 'varchar',
            isNullable: true,
        }));
        ...
        const keys = await queryRunner.manager.find(PrivateKey);
