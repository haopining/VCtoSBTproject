...
export class CredentialIssuerLD {
    ...
    async createVerifiableCredentialLD(args, context) {
        ...
        try {
            ...
            return await this.ldCredentialModule.issueLDVerifiableCredential(credential, identifier.did, signingKey, verificationMethodId, { ...args.options, now }, context);
        }
        catch (error) {
            debug(error);
            return Promise.reject(error);
    ...
    async verifyCredentialLD(args, context) {
        ...
        return this.ldCredentialModule.verifyCredential(credential, args.fetchRemoteContexts || false, { ...args.options, now }, context);
    }
    ...
    async verifyPresentationLD(args, context) {
        ...
        return this.ldCredentialModule.verifyPresentation(presentation, args.challenge, args.domain, args.fetchRemoteContexts || false, { ...args.options, now }, context);
    }
