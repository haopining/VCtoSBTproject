 ...
 */
export function convertIdentifierEncryptionKeys(identifier) {
 ...
 * @beta This API may change without a BREAKING CHANGE notice.
 */
export function compressIdentifierSecp256k1Keys(identifier) {
    return identifier.keys
        .map((key) => {
 ...
 * @beta This API may change without a BREAKING CHANGE notice.
 */
export function getEthereumAddress(verificationMethod) {
 ...
 * @beta This API may change without a BREAKING CHANGE notice.
 */
export function getChainIdForDidEthr(verificationMethod) {
    if (verificationMethod.blockchainAccountId?.includes('@eip155')) {
 ...
 * @beta This API may change without a BREAKING CHANGE notice.
 */
export async function mapIdentifierKeysToDoc(identifier, section = 'keyAgreement', context) {
 ...
 * @beta This API may change without a BREAKING CHANGE notice.
 */
export async function resolveDidOrThrow(didUrl, context) {
    // TODO: add caching
 ...
 * @beta This API may change without a BREAKING CHANGE notice.
 */
export async function dereferenceDidKeys(didDocument, section = 'keyAgreement', context) {
