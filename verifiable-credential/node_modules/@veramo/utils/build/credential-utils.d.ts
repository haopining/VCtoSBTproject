import { CredentialPayload, IMessage, PresentationPayload, VerifiableCredential, VerifiablePresentation, W3CVerifiableCredential, W3CVerifiablePresentation } from '@veramo/core-types';
/**
 ...
 */
export declare function processEntryToArray(inputEntryOrArray?: string | string[] | any, startWithEntry?: string): string[];
/**
